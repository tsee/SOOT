...
my $pad1 = $DistCanvas->cd(1)->as('TPad'); # FIXME workaround for enum bug
$pad1->SetGrid();
...
$leg->AddEntry($fgaus->DrawCopy()->as('TF1'), "Normal(0,1)", "l");
...
$leg->AddEntry($student->DrawCopy("lsame")->as('TF1'), "10 degrees of freedom", "l");

$student->SetParameter(0, 3);
$student->SetLineColor(2);
$leg->AddEntry($student->DrawCopy("lsame")->as('TF1'), "3 degrees of freedom", "l");

$student->SetParameter(0, 1);
$student->SetLineColor(1);
$leg->AddEntry($student->DrawCopy("lsame")->as('TF1'), "1 degree of freedom", "l");

$leg->Draw();

#drawing the set of student cumulative probability functions
my $pad2 = $DistCanvas->cd(2)->as('TPad'); # FIXME workaround for enum bug
...
$leg2->AddEntry($studentI->DrawCopy()->as('TF1'), "10 degrees of freedom", "l");
  
$studentI->SetParameter(0, 3);
$studentI->SetLineColor(2);
$leg2->AddEntry($studentI->DrawCopy("lsame")->as('TF1'), "3 degrees of freedom", "l");

$studentI->SetParameter(0, 1);
$studentI->SetLineColor(1);
$leg2->AddEntry($studentI->DrawCopy("lsame")->as('TF1'), "1 degree of freedom", "l");
$leg2->Draw();
...
my $pad3 = $DistCanvas->cd(3)->as('TPad'); # FIXME workaround for enum bug
$pad3->SetFrameFillColor(19);
$pad3->SetGrid();
 
$fDist->SetParameters(1, 1);
$fDist->SetLineColor(1);
$legF1->AddEntry($fDist->DrawCopy()->as('TF1'), "N=1 M=1", "l");

$fDist->SetParameter(1, 10); 
$fDist->SetLineColor(2);
$legF1->AddEntry($fDist->DrawCopy("lsame")->as('TF1'), "N=1 M=10", "l");

$fDist->SetParameters(10, 1);
$fDist->SetLineColor(8);
$legF1->AddEntry($fDist->DrawCopy("lsame")->as('TF1'), "N=10 M=1", "l");

$fDist->SetParameters(10, 10);
$fDist->SetLineColor(4);
$legF1->AddEntry($fDist->DrawCopy("lsame")->as('TF1'), "N=10 M=10", "l");
...
my $pad4 = $DistCanvas->cd(4)->as('TPad'); # FIXME workaround for enum bug
$pad4->SetFrameFillColor(19);
$pad4->SetGrid();
$fDistI->SetParameters(1, 1);
$fDistI->SetLineColor(1);
$legF2->AddEntry($fDistI->DrawCopy()->as('TF1'), "N=1 M=1", "l");

$fDistI->SetParameters(1, 10); 
$fDistI->SetLineColor(2);
$legF2->AddEntry($fDistI->DrawCopy("lsame")->as('TF1'), "N=1 M=10", "l");
  
$fDistI->SetParameters(10, 1); 
$fDistI->SetLineColor(8);
$legF2->AddEntry($fDistI->DrawCopy("lsame")->as('TF1'), "N=10 M=1", "l");
 
$fDistI->SetParameters(10, 10); 
$fDistI->SetLineColor(4);
$legF2->AddEntry($fDistI->DrawCopy("lsame")->as('TF1'), "N=10 M=10", "l");
