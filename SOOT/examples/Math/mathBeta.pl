...
$c1->Divide(1, 2);
my $pad1 = $c1->cd(1)->as('TPad'); # FIXME the dreaded enum bug
$pad1->SetGrid();
my $fbeta = TF1->new("fbeta", "TMath::BetaDist(x, [0], [1])", 0, 1);
$fbeta->SetParameters(0.5, 0.5);
my $f1 = $fbeta->DrawCopy()->as('TF1'); # FIXME the dreaded enum bug
$f1->SetLineColor(kRed);
$f1->SetLineWidth(1);
$fbeta->SetParameters(0.5, 2);
my $f2 = $fbeta->DrawCopy("same")->as('TF1'); # FIXME the dreaded enum bug
$f2->SetLineColor(kGreen);
$f2->SetLineWidth(1);
$fbeta->SetParameters(2, 0.5);
my $f3 = $fbeta->DrawCopy("same")->as('TF1'); # FIXME the dreaded enum bug
$f3->SetLineColor(kBlue);
$f3->SetLineWidth(1);
$fbeta->SetParameters(2, 2);
my $f4 = $fbeta->DrawCopy("same")->as('TF1'); # FIXME the dreaded enum bug
...
my $pad2 = $c1->cd(2)->as('TPad'); # FIXME the dreaded enum bug
$pad2->SetGrid();
my $fbetai = TF1->new("fbetai", "TMath::BetaDistI(x, [0], [1])", 0, 1);
$fbetai->SetParameters(0.5, 0.5);
my $g1=$fbetai->DrawCopy()->as('TF1'); # FIXME the dreaded enum bug
$g1->SetLineColor(kRed);
$g1->SetLineWidth(1);
$fbetai->SetParameters(0.5, 2);
my $g2 = $fbetai->DrawCopy("same")->as('TF1'); # FIXME the dreaded enum bug
$g2->SetLineColor(kGreen);
$g2->SetLineWidth(1);
$fbetai->SetParameters(2, 0.5);
my $g3 = $fbetai->DrawCopy("same")->as('TF1'); # FIXME the dreaded enum bug
$g3->SetLineColor(kBlue);
$g3->SetLineWidth(1);
$fbetai->SetParameters(2, 2);
my $g4 = $fbetai->DrawCopy("same")->as('TF1'); # FIXME the dreaded enum bug
